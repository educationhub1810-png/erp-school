...
export const NAV_CONFIG: Record<Role, NavItem[]> = {
  ...
  TEACHER: [
    ...
    { label: "Fees", href: "/teacher/fees", icon: IndianRupee },
  ...
  ACCOUNTANT: [
    ...
    { label: "Fee Collection", href: "/accountant/fees/collect", icon: IndianRupee },
    { label: "Fee Structures", href: "/accountant/fees/structures", icon: IndianRupee },
  ...
  TRANSPORT_MANAGER: [
    ...
    { label: "Fees", href: "/transport/fees", icon: IndianRupee },
  ],
  HR_MANAGER: [
  ...
  WARDEN_MANAGER: [
    ...
    { label: "Fees", href: "/warden/fees", icon: IndianRupee },
  ],
  MESS_MANAGER: [
